const DEFAULT_TAGLINE = "All your chats, one ShieldClaw.";
...
const TAGLINES: string[] = [
  ...
  "The only shield in your contacts you actually want to hear from. 🛡️",
  ...
  "You had me at 'shieldclaw gateway start.'",
