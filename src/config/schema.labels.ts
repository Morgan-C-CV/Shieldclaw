...
export const FIELD_LABELS: Record<string, string> = {
  ...
  security: "Security",
  "security.accessZones": "Access Zones",
  "security.accessZones.enabled": "Enable Access Zones",
  "security.accessZones.enforce": "Enforce Access Zones",
  "security.accessZones.logViolations": "Log Access Zone violations",
  "security.accessZones.defaultMode": "Access Zones default mode",
  "security.accessZones.resolveSymlinks": "Resolve Access Zone symlinks",
  "security.accessZones.zones": "Access Zone allowlist",
